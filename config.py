...
# ---------------------------------------------------------------------------
# Target number of samples per class after oversampling.
# Classes already above this count are left untouched (no downsampling).
# Classes below this count get synthetic samples generated by SMOTE.
#
# Current counts:  min=106 (Potato_healthy), max=2245 (Tomato_TYLCV)
# Target=2000 means ALL 15 classes reach ≥2000 samples → true balance.
# (Old target=1000 left majority classes at up to 2245 → still 2.2× imbalance)
